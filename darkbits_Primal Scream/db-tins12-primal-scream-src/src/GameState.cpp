...
std::string GameState::POWERUP_GUN = "gun";
std::string GameState::POWERUP_GRENADE = "grenade";
std::string GameState::POWERUP_HIJUMP = "hijump";
std::string GameState::LOCATION_X = "locx";
std::string GameState::LOCATION_Y = "locy";
