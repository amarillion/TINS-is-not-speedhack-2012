...
public:
	...
	void drawCenter(BITMAP* aBuffer, const std::string& aText, int aX, int aY, int aWidth, int aHeight, int aNumberOfCharacters = -1);
	void drawCenterY(BITMAP* aBuffer, const std::string& aText, int aX, int aY, int aHeight);
	void drawCenterX(BITMAP* aBuffer, const std::string& aText, int aX, int aY, int aWidth);
