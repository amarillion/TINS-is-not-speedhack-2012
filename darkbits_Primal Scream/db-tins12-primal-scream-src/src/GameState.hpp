...
public:
	...
	static std::string POWERUP_GUN;
	static std::string POWERUP_GRENADE;
	static std::string POWERUP_HIJUMP;
	static std::string LOCATION_X;
	static std::string LOCATION_Y;
